...
Geokit::Geocoders::GoogleGeocoder.api_key = 'AIzaSyA0eIACBD5ZeyRPjhqOzEoObxdbxQQKDew'
...
Geokit::Geocoders::BingGeocoder.key = 'AqU7oPgVISZBFJOpgL_1uBBtyOfOc69oKURZ0nlvBW-sML2Cw6l8nNzcvZzywOAQ'
Geokit::Geocoders::MapQuestGeocoder.key = '7ClVmjOBKBo91VZWKLSeZxPyvusrqjSf'
Geokit::Geocoders::MapboxGeocoder.key = 'pk.eyJ1Ijoic2JhZGFtczY2MiIsImEiOiJjaW94bWUwd28wMXF3dTBtNGczODFwMjc0In0.mBg-t4WH0XHZFAaQ_PtpxQ'
Geokit::Geocoders::OpencageGeocoder.key = 'f97d0d7f21317e32ead310e91febed34'
...
Geokit::Geocoders::provider_order = [:google, :bing, :map_quest, :mapbox, :opencage, :ca]
